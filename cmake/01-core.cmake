...
option(BUILD_COMPILER "Build the main compiler executable" ${DEFAULT_ON})
option(BUILD_COMPILER_MSG "Build compiler-msg" ${DEFAULT_ON})
...
if (BUILD_COMPILER OR BUILD_TESTS)
  set(BUILD_LIBPOLY ON)
else()
  set(BUILD_LIBPOLY OFF)
endif()

if (BUILD_LIBPOLY OR BUILD_COMPILER_MSG)
